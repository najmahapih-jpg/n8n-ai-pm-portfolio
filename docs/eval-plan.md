...
**Built — 144 assertions across the 14 scenarios, 0 failures, fully offline.** (The harness runs our own
...
| `npm run verify:workflow` | Layer 2b — the COMPILED jsCode vs the 14 golden scenarios + a differential vs the 4 security gates (144 assertions) | yes |
