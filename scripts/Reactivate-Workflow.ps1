param(
  [string]$WorkflowId = "",
  [string]$MetaPath = ".\workflows\sdk\autonomous-agent.meta.json",
...
#
# NOTE: this repo has no verify:live gate (deploy is manual — review canonical, then PUT
# via the n8n API or MCP, then run this script to re-register the production webhook).
