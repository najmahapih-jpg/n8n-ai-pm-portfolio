...
# Step 2 — live availability gate. smoke is a LIVE-LOCAL-n8n tier check (it exercises a running n8n), NOT an
...
# Step 3 — live behavioral cases (infra is available; must pass).
