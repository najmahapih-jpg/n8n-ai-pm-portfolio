param(
  ...
  [int]$MinimumNodes = 27,
  [string]$Description = "Local Feishu SupportOps triage: validate tickets, classify/score/route/SLA, escalate, create redacted audit events, optionally notify Feishu, respond.",
