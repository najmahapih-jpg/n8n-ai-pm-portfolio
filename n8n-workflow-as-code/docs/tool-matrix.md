...
| n8n Docker server CLI | Local scripts | Docker access | Export workflows for versioning | Reads workflow definitions |
...
- Export uses the n8n server CLI inside the local Docker container.
